...
export default class ReminderApp {
  ...
  private addSampledata(): void {
    this._remindersHandler.addReminder("reminder1", "A");
    this._remindersHandler.addReminder("reminder2", "B");
    this._remindersHandler.addReminder("reminder3", "B");
    this._remindersHandler.addReminder("reminder4", "A");
    this._remindersHandler.addReminder("reminder5", "C");
    this._remindersHandler.addReminder("reminder6", "A");

    //console.log(this._remindersHandler);
  };
  ...
  private handleToggleCompletion(): void {
    if(this._remindersHandler.size() === 0) {
      ...
      const index = Number(this.getUserChoice("reminder number to toggle", true));
  ...
  if(this._remindersHandler.size() === 0) {
    ...
    Logger.logReminders(this._remindersHandler.reminders);
    const index : number = Number(this.getUserChoice("number to modify",false));
    const description = this.getUserChoice("description to modify",false);
    this._remindersHandler.modifyReminder(index -1, description);
  ...
  private handleSearchReminders(): void {
   ...
   if(this._remindersHandler.size() === 0) {
    ...
    Logger.logSearchResults(this._remindersHandler.search(this.getUserChoice("keyword",false)));
    //const keyword4Tag = this.getUserChoice("tag",false);
    this._remindersHandler.search
   }
  }
